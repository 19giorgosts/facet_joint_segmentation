...
class DataLoader():
    def __init__(self, config):
        ...
        self.modality_postfix     = config.get('modality_postfix',['Ultra'])
        self.intensity_normalize  = config.get('intensity_normalize', [True, True, True, True])
        self.with_ground_truth    = config.get('with_ground_truth', True)
    ...
    def __get_patient_names(self):
        ...
        # use all the patient names in data_root
            ...
            patient_names = [name for name in patient_names if 'sweep' in name.lower()]
